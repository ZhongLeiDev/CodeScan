...
public class BatchHandle extends Activity{
	...
	private Handler mhandler = new Handler(){
		public void handleMessage(Message msg){
			if(msg.what == 0x01){
				...
				Toast.makeText(BatchHandle.this, "成功解除锁定！", Toast.LENGTH_SHORT).show();
			}
		}
	};
...
private void showRebuildDialog(){
		...
		new AlertDialog.Builder(BatchHandle.this).setIcon(android.R.drawable.btn_star)  
	    .setTitle("批次表")
	                ...
	                public void onClick(DialogInterface dialog,int which) {
	                	...
	                	if((!batchname.isEmpty())&&(MainActivity.isNumber(batchsum))&&(Integer.parseInt(batchsum)>0)&&(!batchname.equals("EMPTY"))&&(!batchname.equals("NO"))){
	                		...
	                		if(batchdbhelper.updateSum(batchname, batchsum)>0){
	                			new Thread(showRunnable).start();
	                			Toast.makeText(BatchHandle.this, "更新数据库成功！", Toast.LENGTH_SHORT).show();
	                		}else{
	                			Toast.makeText(BatchHandle.this, "更新数据库失败！", Toast.LENGTH_SHORT).show();
	                		}
	                	
	                }else{
	                	Toast.makeText(BatchHandle.this, "输入参数不符合要求，请重新输入！", Toast.LENGTH_SHORT).show();
	                }
	                }
	            })  
...
private void showUnlockDialog(){
    ...
    final EditText edtinput = new EditText(BatchHandle.this); 
                ...
                String sn = edtinput.getText().toString();
                	...
                	if((!sn.isEmpty())){
                		...
                		if((batchdbhelper.updateFlag(sn,"NO"))>0){
                			...
                			Toast.makeText(BatchHandle.this, "解除锁定失败！", Toast.LENGTH_SHORT).show();
                		}
