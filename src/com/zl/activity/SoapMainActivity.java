...
import com.zl.dbmail.DatabaseHandleSoapActivity;
...
//				tvcount.setText(String.valueOf(dbsb.getRowsFromExcel(filename)));//使用读取Excel行数来获取本批次本机已扫描数量，
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("外网扫描模式");//设置Title标签值，起提示作用
...
//			msg.obj = batchlist;
	...
	public boolean onOptionsItemSelected(android.view.MenuItem item) {
		if (item.getItemId() == 1) {
			...
			startActivity(new Intent(SoapMainActivity.this,DatabaseHandleSoapActivity.class));
