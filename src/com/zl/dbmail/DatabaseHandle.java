...
//    	String[] emailReciver = new String[]{"zhonglei@tcl.com"};
    	...
    	startActivity(Intent.createChooser(email, "请选择邮件发送软件"));
    		...
    		Toast.makeText(DatabaseHandle.this, "收件人未指定！", Toast.LENGTH_SHORT).show();
    	}
    	 }else{
    		 Toast.makeText(DatabaseHandle.this, "指定附件不存在，请先查询生成表格后再发送！", Toast.LENGTH_SHORT).show();
    	 }
    }
...
//				}
	...
	private void showBatchQueryDialog(){
		...
		final EditText edtinput = new EditText(DatabaseHandle.this); 
		
		new AlertDialog.Builder(DatabaseHandle.this).setIcon(android.R.drawable.btn_star)  
	                    ...
	                    // TODO Auto-generated method stub  
	                	 ...
	                	 if(!batch.isEmpty()){
	                		 ...
	                		 new Thread(batchQuery).start();
	                			 ...
	                			 Toast.makeText(DatabaseHandle.this, "输入批次已锁定或不存在！", Toast.LENGTH_SHORT).show();
	                		 }
	                	 }else{
	                		 Toast.makeText(DatabaseHandle.this, "请输入批次号！", Toast.LENGTH_SHORT).show();
	                	 }
